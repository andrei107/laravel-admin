<div id="createMenuModal" class="modal fade" tabindex="-1" role="dialog">
                ...
                <div class="general-for-all-languages">
                    ...
                    <div class="number-data-modal">
                        <div class="form-group">
                            <label>Числовой атрибут</label><br>
                            <input type="text" name="menu_id" class="form-control menu_id-field">
                        </div>
                    </div>
                </div>
